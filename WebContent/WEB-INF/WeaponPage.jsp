...
<html>
<head>
<link rel="stylesheet" href="/Mock_Kiranico/css/WeaponPage.css">
  	...
  	<c:forEach items="${weapons}" var="weapon">
    	<tr class = "weapon_attr">
    		...
    		<td style="width: 127px; text-align: center"><c:out value="${weapon.affinity}"/></td>
      		<td style="width: 127px; text-align: center">
      			<c:choose>
      				<c:when test = "${weapon_type == 'light-bowgun' || weapon_type == 'heavy-bowgun'}"> --- </c:when>
      		...
      		<td style="width: 127px; text-align: center">
      			<c:if test = "${weapon_type == 'light-bowgun' || weapon_type == 'heavy-bowgun'}"> --- </c:if>
      			<c:if test = "${weapon_type != 'light-bowgun' && weapon_type != 'heavy-bowgun'}"> ${weapon.element1_atk} </c:if>		
      		</td>
      		<td style="width: 127px; text-align: center">
